...
pub const DEFAULT_TASK_LEAD_TIME_MS: i64 = 7 * 24 * 60 * 60 * 1000;
...
pub fn get_interval_ms(frequency: Frequency, interval: i64) -> i64 {
    ...
    match frequency {
        ...
        Frequency::Weekly => interval * 7 * ONE_DAY_MS,
        Frequency::Monthly => interval * 30 * ONE_DAY_MS,
        Frequency::Yearly => interval * 365 * ONE_DAY_MS,
    }
}
