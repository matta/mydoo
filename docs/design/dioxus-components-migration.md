...
| Label         | [preview/src/components/label](https://github.com/DioxusLabs/components/tree/main/preview/src/components/label)                 | `crates/tasklens-ui/src/dioxus_components/label/`         | Adopted                                                           | Keep vendored source.                                                     |
...
| Slider        | [preview/src/components/slider](https://github.com/DioxusLabs/components/tree/main/preview/src/components/slider)               | `crates/tasklens-ui/src/dioxus_components/slider/`        | Adopted                                                           | Keep vendored source.                                                     |
| Switch        | [preview/src/components/switch](https://github.com/DioxusLabs/components/tree/main/preview/src/components/switch)               | `crates/tasklens-ui/src/dioxus_components/switch/`        | Adopted                                                           | Keep vendored source.                                                     |
...
| Toggle        | [preview/src/components/toggle](https://github.com/DioxusLabs/components/tree/main/preview/src/components/toggle)               | `crates/tasklens-ui/src/dioxus_components/toggle/`        | Adopted                                                           | Keep vendored source.                                                     |
| Toggle Group  | [preview/src/components/toggle_group](https://github.com/DioxusLabs/components/tree/main/preview/src/components/toggle_group)   | `crates/tasklens-ui/src/dioxus_components/toggle_group/`  | Adopted                                                           | Keep vendored source.                                                     |
...
- Adopted: 17 (Badge, Button, Card, Checkbox, Collapsible, Dialog, Input, Label, Navbar, Popover, Progress, Select, Slider, Switch, Textarea, Toggle, ToggleGroup)
