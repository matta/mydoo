...
- Tailwind utility usage matches in app-owned source: reduced to ~115 (from ~180 baseline).
- Highest remaining hotspots: `doc_id_manager.rs` (25), `score_trace_page.rs` (20), `balance_page.rs` (12).
