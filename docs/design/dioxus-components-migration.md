...
| Date Picker   | [preview/src/components/date_picker](https://github.com/DioxusLabs/components/tree/main/preview/src/components/date_picker)     | `crates/tasklens-ui/src/app_components/date_input.rs`, `date_time_input.rs` | App-owned (CSS-module-scoped native wrappers)                     | Keep app-owned native wrappers; revisit upstream picker after blockers are resolved. |
...
- **Usage**: `#[css_module("/src/app_components/date_input.css")] struct Styles;` inside the component; classes accessed as `Styles::date_input`.
