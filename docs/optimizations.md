...
This document tracks potential performance optimizations identified during development. These should be addressed with a principled benchmark-based approach performance becomes a focus.
...
For a list of N tasks, this results in O(N) string allocations per render cycle.
