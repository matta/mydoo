...
use commands::{
    ...
    check_rust_line_count::{CheckRustLineCountArgs, DEFAULT_LIMIT, check_rust_line_count},
    dx_components,
...
enum Commands {
    ...
    CheckDioxusLockPin,
    /// Check Rust line count
    CheckRustLineCount(CheckRustLineCountArgs),
...
fn main() -> Result<()> {
    ...
    match &cli.command {
        Commands::CheckAll => {
            ...
            check_rust_line_count(&CheckRustLineCountArgs {
                all: true,
                limit: DEFAULT_LIMIT,
                print_counts: false,
            })?;
        ...
        Commands::CheckRustLineCount(args) => check_rust_line_count(args)?,
