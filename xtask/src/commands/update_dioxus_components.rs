...
pub(crate) struct UpdateDioxusComponentsArgs {
    ...
    /// direct `dx components add ...` output before local edits.
...
fn run_update_workflow(args: &UpdateDioxusComponentsArgs, context: &WorkflowContext) -> Result<()> {
    ...
    println!(
        "update-dioxus-components completed: target_branch={current_branch}, vendor_branch={}, components_rev={}, primitives_rev={}, components=[{}], snapshot_commit_created={snapshot_commit_created}, vendor_branch_pushed=true",
        args.vendor_branch,
        components_revision,
        primitives_pin.rev,
...
"#;
    ...
    #[test]
    fn renders_canonical_update_invocation_with_revision_check_mode() {
        let args = UpdateDioxusComponentsArgs {
